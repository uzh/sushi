...
EOS
    ...
    @params['strandMode', "context"] = "STAR"
    @params['refFeatureFile'] = 'genes.gtf'
    @params['refFeatureFile', "context"] = "STAR"
    @params['secondRef'] = ''
  ...
  def next_dataset
     dataset = {
        ...
        'StrandFile [Link,File]'=>File.join(@result_dir, "#{@dataset['Name']}_strand.txt"),
