...
EOS
    ...
    @params['paired'] = true
    @params['paired', "context"] = "Spades"
    @params['otherBasicOpt'] = ''
    @params['otherBasicOpt', 'description'] = 'SPAdes basic options: --sc, --rna, --plasmid, --meta, Default is empty for genome assembly without MDA'
    @params['otherBasicOpt', "context"] = "Spades"
    ...
    @params['spadesPipeOpt', "context"] = "Spades"
    @params['cmdOptions'] = ''
    ...
    @params['cmdOptions', "context"] = "Spades"
