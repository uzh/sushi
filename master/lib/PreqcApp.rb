...
EOS
    ...
    @params['dustThreshold', "context"] = "Preqc"
  ...
  def next_dataset
    {'Name'=>@dataset['Name'],
     'PreqcReport [File,Link]'=>File.join(@result_dir, "#{@dataset['Name']}.pdf"),
