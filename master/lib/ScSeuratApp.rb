...
Single cell report<br/>
    ...
    @params['CyteTypeR.llmProvider'] = ['default', 'openai']
    @params['CyteTypeR.llmProvider', 'description'] = 'LLM provider: "default" uses Nygen built-in model, "openai" for custom OpenAI-compatible endpoint (e.g., local GPT-OSS)'
    @params['CyteTypeR.llmBaseUrl'] = ''
    @params['CyteTypeR.llmBaseUrl', 'description'] = 'Base URL for custom LLM endpoint (only when llmProvider is "openai")'
    @params['CyteTypeR.llmApiKey'] = ''
    @params['CyteTypeR.llmApiKey', 'description'] = 'API key for custom LLM endpoint (only when llmProvider is "openai")'
    @params['CyteTypeR.llmModel'] = ''
    @params['CyteTypeR.llmModel', 'description'] = 'Model name for custom LLM endpoint (only when llmProvider is "openai")'
    @params['cellxgeneUrl'] = ''
