...
<b>integer read counts</b> (it estimates a per-sample sampling fraction from
...
native MetaPhlAn relative-abundance output). Functional (HUMAnN) input is
not supported — use DiffShotMaAsLin3 for that.
