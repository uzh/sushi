...
<a href='https://bioconductor.org/packages/release/bioc/html/edgeR.html'>edgeR</a><br/>
    ...
    @params['pValueHighlightThresh'] = 0.01
    @params['pValueHighlightThresh', 'description'] = "pValue cut-off for highlighting candidate features in plots"
    @params['log2RatioHighlightThresh'] = 0.5
    @params['log2RatioHighlightThresh', 'description'] = "log2 FoldChange cut-off for highlighting candidate features in plots"
    ...
    @params['mail'] = ""
    @params['Rversion'] = ["Dev/R/4.1.2", "Dev/R/4.1.0", "Dev/R/4.0.4", "Dev/R/4.0.3", "Dev/R/4.0.1"]
  end
   def preprocess
