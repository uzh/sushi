...
EOS
    ...
    @params['paired'] = false
    @params['paired', "context"] = "Kallisto"
    @params['strandMode'] = ['both', 'sense', 'antisense']
    @params['strandMode', "context"] = "Kallisto"
    @params['refFeatureFile'] = 'genes.gtf'
    @params['refFeatureFile', "context"] = "Kallisto"
    ...
    @params['mail'] = ""
    @modules = ["Tools/samtools", "Aligner/kallisto", "QC/fastp", "Dev/R"]
