...
class SCDifferentialStateApp < SushiFabric::SushiApp
  def initialize
    super
    @name = 'SCDifferentialState'
...
<a href='https://bioconductor.org/packages/release/bioc/html/DifferentialState.html'>DifferentialState</a><br/>
    ...
    @params['mail'] = ""
    @params['Rversion'] = ["Dev/R/4.3.0", "Dev/R/4.1.2", "Dev/R/4.1.0", "Dev/R/4.0.4", "Dev/R/4.0.3"]
  end
   def preprocess
  ...
  def commands
    ...
    command << run_RApp("EzAppSCDifferentialState")
  end
end
