...
Single cell report<br/>
    ...
    @params['column_name_of_cell_label'] = ''
    @params['column_name_of_cell_label', 'description'] = 'After clicking the "explore" button, on the left you will find the column name of cell label. For example, in this dataset, "https://cellxgene.cziscience.com/e/3faad104-2ab8-4434-816d-474d8d2641db.cxg/", the cell label name is "predicted.celltype.l2celltype.l2".'
