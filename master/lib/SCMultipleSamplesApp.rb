...
class SCMultipleSamplesApp < SushiFabric::SushiApp
  def initialize
    super
    @name = 'SCMultipleSamples'
    ...
    @params['node'] = ''
    @params['process_mode'] = 'DATASET'
    @params['name'] = 'SCReportMultipleSamples'
    ...
    @params['mail'] = ""
    @params['Rversion'] = ["Dev/R/4.0.3", "Dev/R/4.0.1", "Dev/R/4.0.4"]
  ...
  def commands
    ...
    command << run_RApp("EzAppSCMultipleSamples")
  end
end
