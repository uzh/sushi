...
<a href='https://ccb.jhu.edu/software/tophat/manual.shtml'>https://ccb.jhu.edu/software/tophat/manual.shtml/</a>
    ...
    @params['bowtie2_index'] = ['GRCh38/BOWTIE2Index/genome', 'hg19/BOWTIE2Index/genome', 'GRCm38/BOWTIE2Index/genome', 'mm10/BOWTIE2Index/genome']
    @params['bowtie2_index', 'description'] = 'bowtie2 index of reference build'
  ...
  def commands
    cmd = "tophat -o . #{num_threads} --library_type #{library_type} #{@params['tophat_options']} #{bowtie2_index} #{@gstore_dir}/#{@dataset['Read1']}"
    if @params['paired']
