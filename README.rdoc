...
As default, there is no user authentification. Please apply the patch, local_devise.20160415.patch, under master directory before executing DB migration (rake db:migrate) as follows:

  $ patch -p0 > local_devise.20160415.patch
