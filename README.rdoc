...
* (Ruby on Rails (>= v4.2.6) this wll be automatically installed through bundler)
...
if you do not want to install the gem libraries in your GEM PATHS directories you can use --path option to specifiy the gem library directory like:
...
# Currently, SUSHI does not have a function to upload the data itself.
# It is the SUSHI framework concept, SUSHI does not manage data itself, but SUSHI does manage the meta-information, called DataSet.
